...
const QuocGiaDetail = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    (async () => {
      const countryToSend = COUNTRY_LABELS[id] || id;
      const res = await filmService.getAllFilms({ quocGia: countryToSend, page, limit: 16, sort: '-createdAt' });
      setFilms(res.films);
